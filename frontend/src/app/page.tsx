...
export default async function HomePage() {
  ...
  const featuredProducts = availableProducts.slice(0, 5)
  const newProducts = [...availableProducts].reverse().slice(0, 4)
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {featuredProducts.length > 0 ? (
            ...
            <EmptyState
              ...
              description="A homepage agora usa somente os produtos vindos da API. Cadastre produtos no back-end para eles aparecerem aqui."
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {newProducts.length > 0 ? (
            ...
            <EmptyState
              type="products"
              title="Sem lançamentos por enquanto"
              description="Quando houver produtos cadastrados no banco, eles aparecem aqui automaticamente."
            />
          )}
        </div>
      </section>
